...
<body style="background-image: url('./IMG/bg4.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
if(isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Display update form with existing job details
        ?>
        <div class="form-container">
        <form method="post" class="update-form" style="background: #7ba2a8;padding-right: 10px;padding-left: 10px;padding-top: 20px;border-radius: 10px;">
            <!-- Add placeholders to form fields -->
            <input type="text" name="job_title" placeholder="Job Title" value="<?php echo $jobDetails['title']; ?>"><br><br>
            <input type="text" name="job_location" placeholder="Job Location" value="<?php echo $jobDetails['location']; ?>"><br><br>
            <textarea name="job_description" placeholder="Job Description"><?php echo $jobDetails['description']; ?></textarea><br><br>
            <input type="text" name="job_keywords" placeholder="Job Keywords" value="<?php echo $jobDetails['keywords']; ?>"><br><br>
            <input type="text" name="job_company" placeholder="Job Company" value="<?php echo $jobDetails['company']; ?>"><br><br>
            <input type="text" name="job_company_url" placeholder="Job Company URL" value="<?php echo $jobDetails['company_url']; ?>"><br><br>
            <textarea name="job_requirements" placeholder="Job Requirements"><?php echo $jobDetails['requirements']; ?></textarea><br><br>
            <textarea name="job_responsibilities" placeholder="Job Responsibilities"><?php echo $jobDetails['responsibilities']; ?></textarea><br><br>
            <input type="text" name="job_contact_email" placeholder="Job Contact Email" value="<?php echo $jobDetails['contact_email']; ?>"><br><br>
            <input type="text" name="job_salary_amount" placeholder="Job Salary Amount" value="<?php echo $jobDetails['salary_amount']; ?>"><br><br>
            <input type="text" name="job_salary_timeframe" placeholder="Job Salary Timeframe" value="<?php echo $jobDetails['salary_timeframe']; ?>"><br><br>
            <textarea name="job_salary_additional_info" placeholder="Job Salary Additional Info"><?php echo $jobDetails['salary_additional_info']; ?></textarea><br><br>
            <input type="checkbox" name="show_salary" <?php if ($jobDetails['show_salary']) echo "checked"; ?>> Show Salary<br><br>
            <input type="submit" name="submit" value="Update"><br><br> 
            <button class='delete-btn'><a href="view_jobs.php" style="text-decoration: none; color: inherit;">Back</a></button><br><br>
            </form>
            <br>
            <br>
        </div>
        ...
        // Check if the form is submitted and call the updateJob function
