...
if(isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM jobs WHERE title LIKE '%$search%' OR location LIKE '%$search%' OR description LIKE '%$search%' OR keywords LIKE '%$search%' OR company LIKE '%$search%'";
    ...
    echo "Error: Search query is missing.";
}

?>
<br>
<center>
<button class='button view-jobs-link'><a href="view_jobs.php" style="text-decoration: none; color: inherit;">Back</a></button>
</center>
<br>
