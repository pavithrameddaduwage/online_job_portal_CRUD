...
<div class="search-container">
    <form action="search.php" method="GET">
        ...
        <button type="submit"class="button view-jobs-link">Search</button>
    </form>
</div>
<br>
...
function getJobs() {
    ...
    if ($result->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Job Title</th><th>Job Location</th><th>Description</th><th>Keywords</th><th>Company</th><th>Company URL</th><th>Requirements</th><th>Responsibilities</th><th>Contact Email</th><th>Salary</th><th>Show Salary</th><th>Action</th></tr>";
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row["salary_amount"] . " " . $row["salary_timeframe"] . "</td>";
            echo "<td>" . ($row["show_salary"] ? 'Yes' : 'No') . "</td>";
            echo "<td><button class='update-btn'><a href='update_job.php?id=" . $row["JobID"] . "'>Update</a></button><br><br> <button class='delete-btn'><a href='delete_job.php?id=" . $row["JobID"] . "'>Delete</a></button></td>";
...
<center>
<button class='button view-jobs-link'><a href="form.php" style="text-decoration: none; color: inherit;">Back</a></button>
</center>
<br>
